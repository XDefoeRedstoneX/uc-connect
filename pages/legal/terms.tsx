    ...
    <SiteLayout title="Syarat & Ketentuan | UC Connect" description="Syarat dan ketentuan penggunaan platform UC Connect.">
      <section className="hero bubble-section">
        <span className="kicker" style={{ position: "relative", zIndex: 1 }}>
          <Icon name="file-text" size={14} strokeWidth={2.6} /> Legal
        </span>
        <h1 className="display" style={{ position: "relative", zIndex: 1, fontSize: "var(--fs-h1)", margin: "0.5rem 0 0" }}>Syarat & Ketentuan</h1>
      ...
      <section className="card compact-top" style={{ maxWidth: "720px", margin: "0 auto" }}>
        <div className="stack" style={{ gap: "1.5rem" }}>
          ...
          <div>
            ...
            <p style={{ color: "var(--muted)", lineHeight: 1.7 }}>
              Pertanyaan? Hubungi kami melalui halaman <Link href="/support" style={{ color: "var(--pacific)" }}>Support</Link>.
            </p>
          </div>
        </div>
      </section>
