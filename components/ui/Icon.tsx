...
/**
 * Single source of truth for line iconography (Lucide-style, 24×24, stroke).
 * Replaces emoji across nav, tabs, stats and categories so the icon language
 * stays consistent regardless of OS emoji rendering.
 */
...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  utensils: <><path d="M3 2v7c0 1.1.9 2 2 2h0a2 2 0 0 0 2-2V2" /><path d="M7 2v20" /><path d="M21 15V2a5 5 0 0 0-3 4.5v6.5a2 2 0 0 0 2 2h1Z" /></>,
  ...
  "sparkle-heart": <path d="M12 21s-7-4.35-9.5-8.5C1 9 2.5 5 6 5c2 0 3.5 1.5 4 2.5C10.5 6.5 12 5 14 5c3.5 0 5 4 3.5 7.5C19 16.65 12 21 12 21z" />,
};
...
type IconProps = {
  ...
  className?: string;
  style?: CSSProperties;
  /** When true the glyph is filled with currentColor (e.g. favorited heart). */
  filled?: boolean;
  title?: string;
};
